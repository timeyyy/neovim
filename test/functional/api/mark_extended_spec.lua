...
-- when > 0
  ...
  it('substitions over multiple lines with newline in pattern #tims3', function()
    feed('A<cr>67890<cr>xx<esc>')
    buffer('set_mark', buf, ns, marks[1], 1, 4)
    buffer('set_mark', buf, ns, marks[2], 1, 5)
    buffer('set_mark', buf, ns, marks[3], 2, 1)
  ...
  it('substitions with multiple newlines in pattern #tim2s1', function()
    feed('A<cr>67890<cr>xx<esc>')
    buffer('set_mark', buf, ns, marks[1], 1, 5)
    buffer('set_mark', buf, ns, marks[2], 1, 6)
    buffer('set_mark', buf, ns, marks[3], 2, 1)
    ...
    feed([[:1,2s:\n.*\n:X<cr>]])
    check_undo_redo(buf, ns, marks[1], 1, 5, 1, 5)
    check_undo_redo(buf, ns, marks[2], 1, 6, 1, 6)
    check_undo_redo(buf, ns, marks[3], 2, 1, 1, 6)
    check_undo_redo(buf, ns, marks[4], 2, 6, 1, 6)
    check_undo_redo(buf, ns, marks[5], 3, 1, 1, 6)
  end)

  it('substitions with multiple newlines in pattern #p1fail', function()
    feed('A<cr>67890<cr>xx<esc>')
    buffer('set_mark', buf, ns, marks[1], 1, 5)
    buffer('set_mark', buf, ns, marks[2], 1, 6)
    buffer('set_mark', buf, ns, marks[3], 2, 1)
  ...
  it('substitions with multiple newlines in pattern #p2fail', function()
    feed('A<cr>67890<cr>xx<esc>')
    buffer('set_mark', buf, ns, marks[1], 1, 5)
    buffer('set_mark', buf, ns, marks[2], 1, 6)
    buffer('set_mark', buf, ns, marks[3], 2, 1)
  ...
  pending('substitions over multiple lines with replace in substition #blah', function()
    ...
    check_undo_redo(buf, ns, marks[3], 1, 5, 2, 1)
